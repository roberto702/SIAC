  ...
  <body>
    ...
    <div class="container">
      <form name="form1" method="post" action="" class="form-signin">
        ...
        <input type="password" name="contra" class="input-block-level" placeholder="Contrasena" autocomplete="off">
...
<?php
		...
		if(!empty($_POST['usuario']) and !empty($_POST['contra'])){
			...
			if(!$dato=mysql_fetch_array($can)){
				if($act=="1"){
					echo '<div class="alert alert-error" align="center"><strong>Usuario y Contrasena Incorrecta</strong></div>';
				}else{
					$act="0";
				}
			}else{
