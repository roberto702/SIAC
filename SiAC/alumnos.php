<?php
		...
		if(!empty($_GET['estado'])){
			...
			if($dat=mysql_fetch_array($cans)){
				...
				$xSQL="Update alumnos Set estado='s' Where id='$rut'";
				mysql_query($xSQL);
				header('location:alumnos.php');
			}
		}
                      ...
                      <div class="span6">
                        ...
                        <div class="btn-group">
                            <button class="btn" data-toggle="dropdown">
                            	<i class="icon-search"></i> <strong>Consultar por Clases</strong> <span class="caret"></span>
                            </button>
        ...
        <td>
        	...
        	<table class="table table-bordered table table-hover">
              <tr class="success">
                ...
                <td width="32%"><center><strong>Clase</strong></center></td>
                <td width="8%">&nbsp;</td>
              </tr>
              <?php
			  	if(empty($_GET['cursos'])){
					if(empty($_POST['bus'])){
						...
						$sql="SELECT * FROM alumnos WHERE nombre LIKE '$bus%' or apellido LIKE '$bus%' or rut='$bus' ORDER BY apellido LIMIT $inicio, $maximo";
					}
				}else{
			  ...
			  ?>
                  <tr>
                    ...
                    <td>
                    	<a href="crear_alumno.php?doc=<?php echo $dato['rut']; ?>" class="btn btn-mini" title="Actualizar Informacion">
                    		<i class="icon-edit"></i>
                        </a>
                    </td>
                  </tr>
	...
	<div class="modal-body">
		<div class="row-fluid">
        	<div class="span6">
              ...
              <input type="text" name="rut" autocomplete="off" required><br>
                <strong>Fecha Nacimiento</strong><br>
