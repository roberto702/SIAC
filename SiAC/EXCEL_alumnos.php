...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td width="10%"><center><strong>Rut</strong></center></td>
    <td width="8%"><center><strong>Telefono</strong></center></td>
    <td width="11%"><strong>Domicilio</strong></td>
    <td width="9%"><center><strong>Estado</strong></center></td>
    <td width="9%"><center><strong>Clase</strong></center></td>
    <td width="10%"><center><strong>Estado Civil</strong></center></td>
    <td width="9%"><strong>Vive Con</strong></td>
  </tr>
 <?php
  	$n=0;$pensionN=0;
  	if($_POST['curso']<>'X'){
  ...
  <tr>
    ...
    <td><center><?php echo $dato['rut']; ?></center></td>
    ...
    <td><center><?php echo $dato['estado_civil']; ?></center></td>
	 <td><center><?php echo $dato['vive_con']; ?></center></td>
